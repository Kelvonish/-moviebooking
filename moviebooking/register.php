...
$password=sha1($password);
   ...
   $result = mysqli_query($con,"SELECT * FROM users WHERE username='$username' OR email='$email'") or die(mysqli_error($con));
...
<section>
        ...
        <p>Confirm Password</p>
				...
				<a href="#">Already have an account?  <a href="login.php" class="btn btn-success">Login</a> </a>
			</form>
		</div>
<section>
